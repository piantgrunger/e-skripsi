      ...
      <!-- ADDED HERE -->
        ...
        <div class="left col-xs-12">
          ...
          <ul class="to_do">
            ...
            <li>
              <div class="row">
                <div class="text-right col-md-3 right"> Revisi Laporan Skripsi</div>
              <div class="right col-md-8"> <?=($model->skripsi->revisi_laporan=='')?'':"<a data-pjax = 0 target='_blank' href='/document/".$model->skripsi->revisi_laporan."'>Download</a>" ?></div>
                     </div>
            </li>
