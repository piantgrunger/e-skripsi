...
class SuratKeluar extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['jenis_surat_id', 'tgl_surat', 'nomor_surat', 'perihal_surat', 'lampiran_surat', 'salam_awal_surat', 'isi_surat', 'salam_akhir_surat', 'jabatan_pengirim_surat', 'nama_pengirim_surat', 'nip_surat','kepada_surat'], 'required'],
